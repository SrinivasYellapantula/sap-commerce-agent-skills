...
2. Build an official documentation ledger.
   ...
   - Record the doc title, version or update-release scope, affected module, concrete change or step, related tool or recipe when documented, and whether the tool is expected to run in dry-run mode first.
